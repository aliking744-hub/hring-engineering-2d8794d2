...
AI_FEATURES = (
    ...
    AiFeatureDefinition("compat.analyze-unicorn", "تحلیل یونیکورن", "آزمایشگاه یونیکورن", "تحلیل ظرفیت رشد و الگوی یونیکورن."),
    AiFeatureDefinition("compat.analyze-unicorn-engine", "موتور تحلیل یونیکورن", "آزمایشگاه یونیکورن", "اجرای تحلیل ساختاریافته موتور یونیکورن."),
    AiFeatureDefinition("compat.track-funding", "رصد جذب سرمایه", "آزمایشگاه یونیکورن", "رصد و تحلیل رویدادهای جذب سرمایه."),
    AiFeatureDefinition("compat.unicorn-ai-chat", "گفت‌وگوی یونیکورن", "آزمایشگاه یونیکورن", "دستیار گفت‌وگویی تحلیل یونیکورن."),
    AiFeatureDefinition("compat.unicorn-web-radar", "رادار وب یونیکورن", "آزمایشگاه یونیکورن", "رصد وب و سیگنال‌های بیرونی مرتبط."),
