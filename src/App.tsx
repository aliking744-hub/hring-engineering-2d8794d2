        ...
        <BrowserRouter>
          <AuthProvider>
            <UserContextProvider>
              ...
              <Route path="/shop" element={<ProtectedRoute><PageVisibilityGate sectionId="page_shop"><Shop /></PageVisibilityGate></ProtectedRoute>} />
              <Route path="/job-description" element={<ProtectedRoute><JobDescriptionGenerator /></ProtectedRoute>} />
              <Route path="/smart-ad-generator" element={<ProtectedRoute><SmartAdGenerator /></ProtectedRoute>} />
              <Route path="/interview-assistant" element={<ProtectedRoute><InterviewAssistant /></ProtectedRoute>} />
              <Route path="/onboarding" element={<ProtectedRoute><OnboardingRoadmap /></ProtectedRoute>} />
              <Route path="/success-architect" element={<ProtectedRoute><SuccessArchitect /></ProtectedRoute>} />
              <Route path="/tools" element={<ProtectedRoute><ToolsGrid /></ProtectedRoute>} />
              ...
              <Route path="/smart-headhunting" element={<ProtectedRoute><SmartHeadhunting /></ProtectedRoute>} />
              <Route path="/campaign/:id" element={<ProtectedRoute><CampaignDetail /></ProtectedRoute>} />
              <Route path="/campaign/:campaignId/candidate/:candidateId" element={<ProtectedRoute><CandidateDetail /></ProtectedRoute>} />
              <Route path="/strategic-compass" element={<ProtectedRoute><StrategicCompass /></ProtectedRoute>} />
              ...
              <Route path="/upgrade" element={<ProtectedRoute><PageVisibilityGate sectionId="page_upgrade"><Upgrade /></PageVisibilityGate></ProtectedRoute>} />
              <Route path="/payment-history" element={<ProtectedRoute><PaymentHistory /></ProtectedRoute>} />
              <Route path="/profile" element={<ProtectedRoute><Profile /></ProtectedRoute>} />
              <Route path="/king744" element={<King744 />} />
              <Route path="/legal-search" element={<ProtectedRoute><LegalSearchPage /></ProtectedRoute>} />
              <Route path="/legal-advisor" element={<ProtectedRoute><PageVisibilityGate sectionId="page_legal"><LegalAdvisor /></PageVisibilityGate></ProtectedRoute>} />
              ...
              <Route path="/strategic-radar" element={<ProtectedRoute><StrategicRadar /></ProtectedRoute>} />
              <Route path="/unicorn-lab" element={<ProtectedRoute><UnicornLab /></ProtectedRoute>} />
