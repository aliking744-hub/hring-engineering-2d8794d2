      ...
      <div className="relative min-h-screen" dir="rtl">
        ...
        <div className="container relative z-10 mx-auto max-w-7xl px-4 py-8">
          ...
          <Tabs defaultValue="companies">
            <TabsList className="mb-5 flex h-auto flex-wrap"><TabsTrigger value="companies">شرکت‌ها</TabsTrigger><TabsTrigger value="users">کاربران</TabsTrigger><TabsTrigger value="credits">اعتبار و دفترکل</TabsTrigger><TabsTrigger value="audit">Audit</TabsTrigger>{canManagePlatform && <TabsTrigger value="ai-economics">AI Economics</TabsTrigger>}</TabsList>
